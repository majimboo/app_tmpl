          ...
          <form @submit.prevent="handleRegister" class="space-y-6">
            ...
            <div class="space-y-2">
              <label for="username" class="block text-sm font-semibold text-gray-700 flex items-center">
                ...
                Choose a Username
                <BaseTooltip text="Your username will be unique and used for login. Choose something memorable but secure." position="top">
            ...
            <div class="space-y-2">
              <label for="password" class="block text-sm font-semibold text-gray-700 flex items-center">
                ...
                Create Password
                <BaseTooltip text="Use a combination of uppercase, lowercase, numbers, and special characters for a strong password." position="top">
                  <svg class="w-4 h-4 ml-2 text-neutral-400 hover:text-neutral-600 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                  </svg>
                </BaseTooltip>
